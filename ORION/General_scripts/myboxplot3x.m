function h1=myboxplot3x(data1,group1,fontsize,grouporder)
...
if nargin <=3
    h1=boxplot(data1,group1,'symbol','');
else
    h1=boxplot(data1,group1,'GroupOrder',grouporder,'symbol','');
end    
...
text(1.3,ylims(2)+step1,strcat('p=',num2str(p12)),'FontSize',fontsize,'color',clr1);
if p23 < 0.05
    clr1 = 'r';
else
    clr1 = 'k';
end
text(2.3,ylims(2)+step1,strcat('p=',num2str(p23)),'FontSize',fontsize,'color',clr1);
if p13 < 0.05
    clr1 = 'r';
else
    clr1 = 'k';
end
text(1.8,ylims(2)+3*step1,strcat('p=',num2str(p13)),'FontSize',fontsize,'color',clr1);
