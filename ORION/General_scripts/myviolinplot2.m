function [h1,p]=myviolinplot2(data1,group1,grouporder,fontsize)
%% My function violinplot 2
%  Jerry Lin 2022/06/21
%  Usage myviolinplot2(groupdata,groups,grouporder)
%  2021/09/19 add features to array only plot

if nargin <=1
    h1 = violinplot(data1);
elseif nargin <=2
    h1=violinplot(data1,group1);
else
    h1=violinplot(data1,group1,'GroupOrder',grouporder);
end
